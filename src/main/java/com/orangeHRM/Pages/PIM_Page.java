...
public class PIM_Page {
    ...
    By  empStatus = By.xpath("//label[text()=\"Employment Status\"]/    By empID = By.xpath(\"//Label[text()= \\\"Employee Id\\\"]//..//../div[2]/input\");\n/..//..//../div[2]/div/div/div[2]/i");
    // "//div[@class = "oxd-select-text-input" and text() = "Full-Time Contract"]"
    By empInclude = By.xpath("//label[text()=\"Include\"]//..//..//../div/div/div/div[2]/i");
    By empSupervisor = By.xpath("//label[text()=\"Supervisor Name\"]//..//../div[2]/div/div/input");
    By jobTitle = By.xpath("//label[text()=\"Job Title\"]//..//../div[2]/div/div/div/i");
    By subUnit = By.xpath("//label[text()=\"Sub Unit\"]//..//../div/div/div[2]/input");
    By searchClick = By.xpath("//button[@type= \"submit\"]");
